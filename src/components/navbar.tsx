      ...
      <nav className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-3">
            <a
              href="#contact"
              className="relative inline-flex items-center justify-center overflow-hidden text-sm font-medium rounded-3xl text-neutral-50 group transition-all duration-300"
            >
              <span className="px-4 py-2 transition-all ease-in duration-75 bg-neutral-950/80">
                Let's talk 👋
              </span>
            </a>
          </div>
